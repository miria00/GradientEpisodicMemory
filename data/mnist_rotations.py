...
parser.add_argument("--min_rot", default=0.0, type=float, help="minimum rotation")
parser.add_argument("--max_rot", default=90.0, type=float, help="maximum rotation")
...
for t in range(args.n_tasks):
    min_rot = 1.0 * t / args.n_tasks * (args.max_rot - args.min_rot) + args.min_rot
    max_rot = (
        1.0 * (t + 1) / args.n_tasks * (args.max_rot - args.min_rot) + args.min_rot
    )
